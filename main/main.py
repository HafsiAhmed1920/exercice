...
from process.process import create_dataset_join1 , create_dataset_join2 , create_dataset_join3
#main 
...
leftjoin1 = create_dataset_join1(maag_master,reac_ref,['c_act_type', 'n_applic_infq']) 
leftjoin2 = create_dataset_join2(leftjoin1 , maag_repa , ['N_APPLIC_INFQ' ,'C_MAST_AGREM_REFER'])
leftjoin3 = create_dataset_join3(leftjoin2 , maag_raty , 'c_mast_agrem_refer')
